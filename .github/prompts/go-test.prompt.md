---
description: "httpc: Run Go tests with race detection, check coverage, and diagnose failures."
agent: "go-fixer"
---
...
5. Identify functions with coverage below 70%

Focus on recently changed files first. Use `git diff --name-only -- '*.go'` to identify them.
