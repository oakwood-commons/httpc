---
description: "httpc: File a GitHub issue with codebase exploration and feasibility assessment."
agent: "issue-creator"
argument-hint: "Describe the change, bug, or feature (e.g., 'Add HTTP/2 support')"
---
...
2. **Assess** feasibility, scope (XS/S/M/L), risks, and affected areas
